function   [ClassRate,num1,label]=rulelearning_test(training,testS,Gamma,testL,dell,number,type,kernel)
% This function is used for rule extraction from SVM. 
% The number of rules is given. 
...
% dell:  number of coverage points 
